...
L:RegisterTranslations("zhCN", function() return {
	...
	-- Gossip Menu
	--------------
	["Gossip"] = "闲聊窗口+重复任务", -- Need translation
	["Automatically complete quests and skip gossip text"] = "自动跳过某些NPC的闲聊窗口，自动交接重复任务（蓝色问号任务）|CFFFF0000(按住Shift点击NPC则不会自动跳过闲聊窗口)|r",
	["Enabled"] = "启用",
