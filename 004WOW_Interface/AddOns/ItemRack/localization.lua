...
ItemRackText.INVTYPE_CONTAINER = "容器"
ItemRackText.MOUNTCHECK = "^速度提高" -- used only for checking if a mount buff is a real one
...
ItemRackText.CONTROL_OPTIONS_TEXT = "设置"
ItemRackText.CONTROL_OPTIONS_TOOLTIP = "Change ItemRack settings."
ItemRackText.OPT_TOOLTIPFOLLOW_TEXT = "鼠标提示"
...
ItemRackText.OPT_FLIPMENU_TEXT = "翻转菜单"
...
ItemRackText.OPT_RIGHTCLICK_TEXT = "TrinketMenu 饰品插件"
...
ItemRackText.OPT_SHOWICON_TEXT = "小地图按钮"
...
ItemRackText.OPT_DISABLETOGGLE_TEXT = "小地图设置"
...
ItemRackText.OPT_FLIPBAR_TEXT = "翻转动作条增长"
...
ItemRackText.OPT_ENABLEEVENTS_TEXT = "启用事件"
...
ItemRackText.OPT_SHOWALLEVENTS_TEXT = "显示所有事件"
...
ItemRackText.SETS_BINDBUTTON_TEXT = "快捷键"
ItemRackText.SETS_BINDBUTTON_TOOLTIP = "Bind a key to this set."
ItemRackText.SETS_SAVEBUTTON_TEXT = "保存"
...
ItemRackText.SETS_REMOVEBUTTON_TEXT = "移除"
...
ItemRackText.SETS_LOADBUTTON_TEXT = "装备"
...
ItemRackText.UNDEFINEDEVENT_TEXT = "未定义"
...
ItemRackText.ENABLEEVENT_TEXT = "启用事件"
...
ItemRackText.EVENTSDELETE_TEXT = "删除事件"
...
ItemRackText.EVENTSEDIT_TEXT = "编辑事件"
...
ItemRackText.EVENTSNEW_TEXT = "新建事件"
ItemRackText.EVENTSNEW_TOOLTIP = "Create a new event.\n\nSome knowledge of lua or WoW macros helps immensely in dealing with events."

ItemRackText.EVENTSSAVE_TEXT = "保存事件"
...
ItemRackText.EVENTSTEST_TEXT = "测试脚本"
...
ItemRackText.EVENTTRIGGER_TEXT = "事件触发"
...
ItemRackText.EVENTDELAY_TEXT = "事件延迟"
...
ItemRackText.RESETBUTTON_TEXT = "重置动作栏"
...
ItemRackText.RESETEVENTSBUTTON_TEXT = "重置事件"
...
ItemRackText.HELP = "使用说明\n1.打开角色面板(C键)\n2.Alt+点击装备栏\n3.Alt+点击角色\n4.在新建动作条上点右键\n5.在弹出的设置面板中点击装备栏\n6.高亮选中，黯淡忽略\n7.点击装备输入装备配置名称,选择图标\n8.点击保存\n△右击小地图图标也可以打开设置菜单,一键脱装需要|CFFFFF569行囊|R有足够空间\n|CFFC41F38☆☆☆☆☆|R\n汉化:Elysium服-|CFFABD473KMUST|R\n邮箱:|CFFD2B48C2604083385@qq.com|R"
